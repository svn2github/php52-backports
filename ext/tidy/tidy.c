...
/* $Id: tidy.c 293036 2010-01-03 09:23:27Z sebastian $ */
...
static PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c 293036 2010-01-03 09:23:27Z sebastian $)");
